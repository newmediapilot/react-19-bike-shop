      ...
      <div className="max-w-sm w-full p-6 border space-y-4">
        ...
        <form className="space-y-4" onSubmit={onSubmit}>
          ...
          <div className="flex gap-2 justify-between">
            <NavLink to="/listings" className="btn btn-primary border border-1 border-gray-200">
              Login
            </NavLink>
            <NavLink to="/listings" className="btn btn-primary border border-1 border-gray-800">
              Register
            </NavLink>
          </div>
        </form>
